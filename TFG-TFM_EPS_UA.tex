...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Título y subtítulo
\newcommand{\titulo}{Evaluación y mejora de la capacidad predictiva de diferentes modelos de redes neuronales sobre lenguajes formales}
\newcommand{\subtitulo}{Subtítulo del proyecto}
% Datos del autor
\newcommand{\miNombre}{Alba Carmona Quirante}
\newcommand{\miEmail}{acq17@alu.ua.es}
% Datos del tutor/es
\newcommand{\miTutor}{Juan Antonio Pérez Ortiz}
\newcommand{\departamentoTutor}{Departamento de Lenguajes y Sistemas Informáticos (DLSI)}
